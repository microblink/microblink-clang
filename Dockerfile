...
RUN cd /home/build && \
    curl -o llvm.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/llvm-${LLVM_VERSION}.src.tar.xz && \
    tar xf llvm.tar.xz && \
    mv llvm-${LLVM_VERSION}.src llvm && \
    curl -o clang.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/cfe-${LLVM_VERSION}.src.tar.xz && \
    tar xf clang.tar.xz && \
    mv cfe-${LLVM_VERSION}.src clang && \
    curl -o extra.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/clang-tools-extra-${LLVM_VERSION}.src.tar.xz && \
    tar xf extra.tar.xz && \
    mv clang-tools-extra-${LLVM_VERSION}.src clang-tools-extra && \
    curl -o libcxx.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/libcxx-${LLVM_VERSION}.src.tar.xz && \
    tar xf libcxx.tar.xz && \
    mv libcxx-${LLVM_VERSION}.src libcxx && \
    curl -o libcxxabi.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/libcxxabi-${LLVM_VERSION}.src.tar.xz && \
    tar xf libcxxabi.tar.xz && \
    mv libcxxabi-${LLVM_VERSION}.src libcxxabi && \
    curl -o lldb.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/lldb-${LLVM_VERSION}.src.tar.xz && \
    tar xf lldb.tar.xz && \
    mv lldb-${LLVM_VERSION}.src lldb && \
    curl -o compiler-rt.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/compiler-rt-${LLVM_VERSION}.src.tar.xz && \
    tar xf compiler-rt.tar.xz && \
    mv compiler-rt-${LLVM_VERSION}.src compiler-rt && \
    curl -o libunwind.tar.xz https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/libunwind-${LLVM_VERSION}.src.tar.xz && \
